...
fun_my = zeros(1,length(iter_range));
fun_my_1 = zeros(1,length(iter_range));
fun_my_2 = zeros(1,length(iter_range));
fun_my_3 = zeros(1,length(iter_range));
...
figure
plot(iter_range,fun_my,'-o','color',[0.85,0.1,0.1],'LineWidth',1.5)
hold on
plot(iter_range,fun_my_1,'-d','color',[0.1,0.1,0.1],'LineWidth',1.5)
plot(iter_range,fun_my_2,'-s','color',[0.54,0.3,0.35],'LineWidth',1.5)
plot(iter_range,fun_my_3,'-^','color',[0,0.5,0],'LineWidth',1.5)
hold off
